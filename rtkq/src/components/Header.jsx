...
const Header = () => {
  return (
    <div className="flex flex-col w-full sevenh:flex-row justify-between items-center bg-black border-b border-red-600 text-red-800 font-bold shadow-[0px_4px_38px_darkred] p-6">
      <Link to="/"><span className="w-full flex items-center text-3xl sevenh:text-2xl">How to use RTK-Query ?</span></Link>
      
      <div className="flex justify-end items-center text-xl twelfh:w-88 mt-1">
         <Link to="/uploadestate"><div className="text-lg flex items-center pr-10 sevenh:mt-0 sevenh:pr-8">Upload Estate</div></Link>
         <div className="flex flex-row">
          <Link to="/signin"><div className="text-lg flex flex-row items-center pr-4 sevenh:mt-0"><FaSignInAlt /><span className="pl-2">Singin</span></div></Link>
