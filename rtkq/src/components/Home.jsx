...
<div className="menu w-4/5 m-auto">
    <div className="menu w-full flex justify-center items-center mt-14 border-2 border-red-800 p-8 shadow-[0px_4px_38px_darkred]">
        <div className="text-2xl fiveh:text-4xl eighth:text-6xl twelfh:text-8xl text-red-800">RTK Queries</div>
    </div>
        <div className='w-full text-sm grid grid-cols-2 gap-1 grid-rows-4 twelfh:grid twelfh:grid-cols-4 twelfh:grid-rows-2 mt-4 text-red-800 fiveh:text-lg fiveh:font-semibold'>
           ...
           {/* <Link to="/uploadestate" className=" flex justify-center items-center p-2 border-2 border-red-800">Upload Document</Link> */}

           <div className="relative flex justify-center items-center border-2 border-red-800 cursor-pointer" >
              <Link to={isLoggedIn && "uploadestate"} className="w-full flex items-center justify-center" onClick={getAccess}>Upload Document</Link>
           ...
           <div className="relative flex justify-center items-center border-2 border-red-800 cursor-pointer">
              <Link to={isLoggedIn && "updatecredentials"} className="w-full flex items-center justify-center" onClick={getAccess}>Update Credentials</Link>
                {message ? <div className="w-full h-full flex items-center justify-center absolute bg-red-800 text-black top-0 left-0 bottom-0 right-0">
